...
def page_mathematical_foundation():
    ...
    ax.set_xlabel(T("math_dist_label"), fontsize=12)
    ax.set_ylabel(T("math_sim_label"), fontsize=12)
    ax.set_title(T("math_chart_title"), fontsize=14, fontweight="bold")
...
def page_svm_concepts():
    ...
    with tabs[0]:
        ...
        ax.set_title(T("hyperplane_chart"), fontsize=14, fontweight="bold")
        ax.set_xlim(-1.5, 1.5)
        ax.set_ylim(-1.5, 1.5)
        ax.set_aspect("equal")
        st.pyplot(fig)
